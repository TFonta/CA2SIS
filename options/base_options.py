...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ds_mode', type=str, default='celeba', help='celeba,ade20k,cityscapes')
        ...
        parser.add_argument('--fixed_lr', action='store_true', help='do not update learning rate.')
